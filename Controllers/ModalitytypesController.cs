...
namespace Ris2022.Controllers
{
    public class ModalitytypesController : Controller
    {
        ...
        // GET: Modalitytypes
        [Authorize(Policy = "Index+DetailsModalityTypesPolicy")]
        ...
        [Authorize(Policy = "CreateModalityTypesPolicy")]
        ...
        [Authorize(Policy = "EditModalityTypesPolicy")]
        ...
        [Authorize(Policy = "DeleteModalityTypesPolicy")]
